...
export interface LotteryMsgCreateBetResponse {
  lotteryId?: string;
...
export interface LotteryMsgUpdateSystemInfoResponse {
  success?: boolean;
}
...
/**
 * @title lottery/lottery/bet.proto
